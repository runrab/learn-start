  ...
  <Layer :layer="layer" @confirm="submit" ref="layerDom">
    <el-form :model="form" :rules="rules" ref="ruleForm" label-width="120px" style="margin-right:30px;">
      ...
      <el-form-item label="手机号：" prop="phone">
        <el-input v-model="form.phone" placeholder="只能输入正整数"></el-input>
      </el-form-item>
      <el-form-item label="学号：" prop="stuNum">
        <el-input v-model="form.stuNum" placeholder="只能输入正整数"></el-input>
      </el-form-item>
      <el-form-item label="邮箱：" prop="mail">
        <el-input v-model="form.mail" placeholder="只能输入正整数"></el-input>
      </el-form-item>
      ...
      <el-form-item label="上学时间：" prop="startDate">
        <el-input v-model="form.startDate" placeholder="请输入上学时间"></el-input>
      </el-form-item>
      <el-form-item label="毕业时间：" prop="endDate">
        <el-input v-model="form.endDate" placeholder="请输入毕业时间"></el-input>
      </el-form-item>
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const rules = {
      ...
      startDate: [{ required: true, message: '请输入上学时间', trigger: 'blur' }],
      endDate: [{ required: true, message: '请输入毕业时间', trigger: 'blur' }],
